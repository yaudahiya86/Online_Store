...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ Route::currentRouteName() == 'databarang' ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('databarang') }}">
                    <i class="fas fa-box"></i>
                    <span>Data Barang</span>
                </a>
            </li>
            <li class="nav-item {{ Route::currentRouteName() == 'datakategori' ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('datakategori') }}">
                    <i class="fas fa-tags"></i>
                    <span>Data Kategori</span>
                </a>
            </li>
            <li class="nav-item {{ Route::currentRouteName() == 'datapesanan' ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('datapesanan') }}">
                    <i class="fas fa-shopping-cart"></i>
                    <span>Data Pesanan</span>
                </a>
            </li>
            <li class="nav-item {{ Route::currentRouteName() == 'datauser' ? 'active' : '' }}">
